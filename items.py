...
if node.os == 'debian' and node.os_version[0] >= 13:
    dhcp4['Dhcp4']["control-socket"]["socket-name"] = "kea4-ctrl-socket"
    dhcp6['Dhcp6']["control-socket"]["socket-name"] = "kea6-ctrl-socket"
    dhcp_ddns['DhcpDdns']["control-socket"]["socket-name"] = "kea-ddns-ctrl-socket"
...
files = {
    ...
    '/etc/kea/kea-api-password': {
        ...
        'group': '_kea',
        'mode': '0600',
        'content': repo.vault.password_for("kea_api_password_{}".format(node.name), length=16).value,
    ...
    '/etc/kea/kea-ctrl-agent.conf': {
        ...
        'group': 'root',
        'mode': '0644',
        'source': 'kea-ctrl-agent.conf',
        'content_type': 'mako',
        # 'content': format_config(ctrl_agent) + "\n",
        'context': {'ctrl_agent': ctrl_agent},
